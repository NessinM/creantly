...
For developers migrating from **Radix UI**, many of our **UI primitives** include instructions and projects for translating equivalent Radix components to Base UI. This ensures a smooth transition while preserving accessibility, behaviors, and API patterns.
...
- **[Agent Skills](/ui/docs/skills)** — Install creantly knowledge directly into your AI assistant with `npx skills add NessinM/creantly`. Covers all 53 primitives, styling conventions, migration patterns, and particle projects.

...
- Offering clear prop mappings and code projects
...
creantly does **not** use the community [`input-otp`](https://github.com/guilhermerodz/input-otp) package. OTP entry is implemented with [Base UI OTP Field](https://base-ui.com/react/components/otp-field) (`OTPFieldPreview`) via the `@creantly/otp-field` registry item (`components/ui/otp-field.tsx`).

**Quick Checklist:**
- Remove the `input-otp` dependency from your app; rely on `@base-ui/react` through creantly
...
- [Component Documentation](/ui/docs/components) - Individual component docs with projects
